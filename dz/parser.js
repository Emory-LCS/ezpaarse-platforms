...
module.exports = new Parser(function analyseEC(parsedUrl, ec) {
  ...
  if ((/^\/suche\/ssearch\/?$/i.test(path)) || (/^\/en\/search\/ssearch\/?$/i.test(path)) || (/^\/zeitschriften\/?$/i.test(path))) {
  ...
  } else if ((/^\/dms\/toc\/?$/i.test(path)) || (/^\/en\/dms\/toc\/?$/i.test(path))) {
  ...
  } else if ((/^\/dms\/met\/?$/i.test(path)) || (/^\/en\/dms\/met\/?$/i.test(path))) {
  ...
  } else if ((/^\/dms\/resolveppn\/?$/i.test(path)) || (/^\/dms\/img\/?$/i.test(path)) || (/^\/en\/dms\/img\/?$/i.test(path))) {
